...
public class Placemarks extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            attrs.setImageAddress("gov/nasa/worldwindx/examples/images/blue-marker.png");
...
//            attrs.setImageOffset(new Offset(0.5, 0.5, AVKey.FRACTION, AVKey.FRACTION));
        ...
        List<Placemarks> parse() {
            try {
                InputStream is = new FileInputStream("./library.json");
                String jsonData =  readSource(is);
                PlacemarkParser PlacemarkParser = new PlacemarkParser();
                PlacemarkParser.parsePlacemarks(jsonData);
            } catch (IOException e) {
